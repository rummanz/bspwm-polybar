...
COLOR_NEWDEVICE='#fff'          # New Device
...
show_menu () {
    menu="$(rofi -sep "|" -dmenu -i -p "$1" -location $LOCATION -yoffset $YOFFSET -xoffset $XOFFSET -theme $THEME -width $WIDTH -hide-scrollbar -line-padding 4 -padding 20 -lines 5 -font "tewi 8" <<< "Battery: $3%|Ping|Find Device|Send File|Unpair")"
                case "$menu" in
...
show_pmenu () {
    menu="$(rofi -sep "|" -dmenu -i -p "$1" -location $LOCATION -yoffset $YOFFSET -xoffset $XOFFSET -theme $THEME -width $WIDTH -hide-scrollbar -line-padding 1 -padding 20 -lines 1 -font "tewi 8"<<< "Pair Device")"
                case "$menu" in
...
show_pmenu2 () {
    menu="$(rofi -sep "|" -dmenu -i -p "$1 has sent a pairing request" -location $LOCATION -yoffset $YOFFSET -xoffset $XOFFSET -theme $THEME -width $WIDTH_WIDE -hide-scrollbar -line-padding 4 -padding 20 -lines 2 -font "tewi 8" <<< "Accept|Reject")"
                case "$menu" in
